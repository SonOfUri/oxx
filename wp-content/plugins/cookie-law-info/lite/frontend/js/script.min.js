! function(e) {
    ...
    function y() {
        h(), !0 === n._bannerConfig.config.revisitConsent.status && A()
    }
    ...
    function f() {
        ...
        function() {
            ...
            })(t), document.body.insertAdjacentHTML("afterbegin", t.body.innerHTML), "classic" === b() && g("=settings-button", "false");
            M(),
                function() {
                    ...
                    e.map(t => {
                        ...
                        g(o, "false"), a(n, ({
                            ...
                            }(n, "cky-accordion-active", !1) ? (g(o, "true"), e.filter(e => e !== t).map(e => {
                                u("#ckyDetailCategory" + e, "cky-accordion-active", !1), g(`#ckyDetailCategory${e} .cky-accordion-btn`, "false")
                            })) : g(o, "false")
                        })
                    })
                }(),
                function() {
                    ...
                    a("=settings-button", () => x("settings-button")), a("=detail-close", () => S()), a("=optout-cancel-button", () => S()), a("=close-button", () => (c._ckySetInStore("action", "yes"), void y())), a("=donotsell-button", () => x("donotsell-button")), a("=reject-button", D("reject")), a("=accept-button", D("all")), a("=detail-accept-button", D("all")), a("=detail-save-button", D()), a("=detail-category-preview-save-button", D()), a("=optout-confirm-button", D()), a("=detail-reject-button", D("reject")), a("=revisit-consent", () => _revisitCkyConsent()), a("=optout-close", () => S())
                }(),
                function() {
                    ...
                    ! function(e, t, {
                        ...
                        if (e.checked = n, e.disabled = o, e.style.backgroundColor = n ? r : s, q(e, n, t, i), !c) return;
                        e.addEventListener("change", ({
                            currentTarget: n
                        }) => {
                            const o = n.checked;
                            n.style.backgroundColor = o ? r : s, q(e, o, t, i)
                        })
                ...
                function() {
                    ...
                    const [n, o] = T("ccpa" === e ? "optout-popup" : "detail");
                    j(n, o, !0), j(o, n)
                }()
        }(),
        function() {
    ...
    async function p() {
        try {
            f(),
                function() {
                    for (const e of n._categories) "yes" !== c._ckyGetFromStore(e.slug) && I(e)
    ...
    function S() {
        ...
        e && e.classList.remove(E()), "classic" !== b() ? (! function() {
            ...
            e && e.classList.add("cky-hide")
        }(), c._ckyGetFromStore("action") || v()) : (g("=settings-button", "false"), u("=notice", "cky-consent-bar-expand")), c._ckyGetFromStore("action") && A();
    ...
    function L() {
        const e = C();
        e && e.classList.toggle(E()), "classic" !== b() && function() {
            const e = document.querySelector(".cky-overlay");
    ...
    function E() {
        return "classic" === b() ? "cky-consent-bar-expand" : "cky-modal-open"
    }
    ...
    function x(e = !1) {
        n._preferenceOriginTag = e, "classic" === b() ? (L(), g("=settings-button")) : w()
    }
    ...
    function M(e = !1) {
        for (const t of n._categories) {
            ...
            N(t, "yes" === o || !o && t.defaultConsent[m()] || t.isNecessary, t.isNecessary, n._shortCodes.find(e => "cky_category_toggle_label" === e.key).content.replace("[cky_preference_{{category_slug}}_title]", t.name), e), O(t)
        }
    }

    function N(e, t, o, c, r = !1) {
        ...
        ["ckyCategoryDirect", "ckySwitch"].map(s => {
            ...
            }(u, e, r), u.checked = t, u.disabled = o, u.style.backgroundColor = t ? i : a, q(u, t, c), r || u.addEventListener("change", ({
                currentTarget: e
            }) => {
                const t = e.checked;
                e.style.backgroundColor = t ? i : a, q(u, t, c)
            }))
        })
    }
        ...
        return () => {
            ! function(e = "all") {
                ...
                for (const s of n._categories) {
                    let n = "no";
                    n = "gdpr" === t ? s.isNecessary || "reject" !== e && ("custom" !== e || W(s.slug)) ? "yes" : "no" : o && !s.defaultConsent.ccpa ? "no" : "yes", c._ckySetInStore("" + s.slug, n), "no" === n ? (r.rejected.push(s.slug), I(s)) : r.accepted.push(s.slug)
                }
                B()
            }(e), y(), S(),
                function() {
    ...
    document.createElement = (...e) => {
        ...
        return Object.defineProperties(t, {
            src: {
                ...
                set: function(e) {
                    return U(t, e) && n("type", "javascript/blocked"), n("src", e), !0
                }
            },
            type: {
                get: function() {
                ...
                set: function(e) {
                    return e = U(t) ? "javascript/blocked" : e, n("type", e), !0
                }
            }
        }), t.setAttribute = (e, o) => {
            if ("type" === e || "src" === e) return t[e] = o;
            n(e, o), "data-cookieyes" !== e || U(t) || n("type", "text/javascript")
        }, t
    };
            ...
            for (const e of t)
                if (e.src && e.nodeName && ["script", "iframe"].includes(e.nodeName.toLowerCase())) try {
                    const t = e.src.startsWith("//") ? `${window.location.protocol}${e.src}` : e.src,
                        ...
                        s = `${o}${r}`.replace(/^www./, "");
                    if (H(e, s), !R(s)) continue;
                    const i = c._ckyRandomString(8, !1);
                    if ("iframe" === e.nodeName.toLowerCase()) K(e, i);
                    else {
    ...
    function R(e) {
        ...
        return t && t.categories.some(e => F(e))
    }

    function U(e, t) {
        return e.hasAttribute("data-cookieyes") && F(e.getAttribute("data-cookieyes").replace("cookieyes-", "")) || R(t || e.src)
    }
